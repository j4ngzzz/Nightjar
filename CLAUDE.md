...
- Sentry integration (errors → invariant candidates)
- LP dual root-cause diagnosis on retry exhaustion
- 19 Proven spec rewrite rules (pre-generation normalization)
...
- DSPy SIMBA prompt optimization (`nightjar optimize`)
