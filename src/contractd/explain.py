...
_FIX_SUGGESTIONS: dict[str, str] = {
    ...
    "deps": (
        "Run 'contractd lock' to regenerate deps.lock. "
    ...
    "formal": (
        ...
        "may be able to fix this automatically — try 'contractd retry'."
    ),
}

_TIMEOUT_FIX = (
    "Verification timed out. Try increasing the timeout in contractd.toml "
...
def load_report(contract_path: str) -> Optional[dict]:
    ...
    Returns:
        Parsed verification report dict, or None if no report exists.
    """
